  ...
  return (
    <div class="mainContainer">
      <div class="orderStatusContainer">
        <ion-icon
          class={
            isOrderSuccessful ? "statusIcon success" : "statusIcon failure"
          }
          name={isOrderSuccessful ? "checkmark" : "close-outline"}
        ></ion-icon>
        <div class="orderStatus">
          Order {isOrderSuccessful ? "Confirmed" : "Failure"}
        </div>
      ...
      <div class="details">
        ...
        website. We operate this site for promoting and selling the products and
        services supplied by us. By using this site, you signify your acceptance
        of these conditions in return for which we will provide you with access.
        From time to time we may modify the conditions so please continue to
        review the conditions of use whenever accessing or using this site. If
        at any time you do not wish to accept these conditions then you may not
        use this site.
      </div>
      <div className="continueShopping">
        <button className="placeOrderBtn">Continue Shopping</button>
      </div>
    </div>
  );
};
